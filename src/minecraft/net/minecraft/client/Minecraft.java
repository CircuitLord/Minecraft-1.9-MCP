...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    private void func_184117_aA()
    {
      ...
      //=========MODDED ADDITION BEGIN=========
        while (this.gameSettings.keyBindPutUp.isPressed())
        {
        	
        	InventoryPlayer inventoryplayer = this.thePlayer.inventory;
        	
        	Container cont = this.thePlayer.inventoryContainer;
        	Slot slot = cont.inventorySlots.get(36 + inventoryplayer.currentItem);
        	
        	this.playerController.func_187098_a(cont.windowId, slot.slotNumber, 0, ClickType.QUICK_MOVE, this.thePlayer);
        }
      //=========MODDED ADDITION END=========
